    ...
    @endif
                        ...
                        <span class="font-small ml-5 text-muted"> ({{ count($reviewcount)}} reviews)</span>
                            ...
                            <div class="attr-detail attr-size mb-30">
                                    <strong class="mr-10" style="width:50px;">Size : </strong>
                                     <select class="form-control unicase-form-control" id="size" id="dsize">
                       ...
                       <div class="attr-detail attr-size mb-30">
                               <strong class="mr-10" style="width:50px;">Color : </strong>
                                <select class="form-control unicase-form-control" id="size" id="dcolor">
                            ...
                            <div class="detail-extralink mb-50">
                                <div class="detail-qty border radius">
                                    ...
                                    <input type="text" name="quantity" class="qty-val" value="1" min="1" id="dqty">
                                                ...
                                                <div class="single-comment justify-content-between d-flex mb-30">
                                                    <div class="user justify-content-between d-flex">
                                                        <div class="thumb text-center">
                                                            <img src="{{ (!empty($item->user->photo)) ? url('upload/users_image/'.$item->user->photo):url('upload/no_image.jpg') }}" alt="" />
