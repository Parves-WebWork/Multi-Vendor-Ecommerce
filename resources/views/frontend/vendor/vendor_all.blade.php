            ...
            <div class="col-12 col-lg-8 mx-auto">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>We have <strong class="text-brand">{{count($vendorsname)}}</strong> vendors now</p>
                    </div>
        ...
        <div class="vendor-img-action-wrap">
            <div class="vendor-img">
                <a href="{{route('vendor.details',$vendor->id)}}">
                    <img class="default-img" src="{{ (!empty($vendor->vendor->photo)) ? url('upload/vendor_images/'.$vendor->vendor->photo):url('upload/no_image.jpg') }}" style="width: 120px;height:120px" alt="" />
                </a>
            </div>
