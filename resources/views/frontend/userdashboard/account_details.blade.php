...
<div class="row">
    ...
    <div class="form-group col-md-12">
      ...
      <div class="form-group col-md-12">
        ...
        <img id="showImage" src="{{ !empty($UserData->photo) ? url('upload/users_image/' . $UserData->photo) : url('upload/no_image.jpg') }}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
    </div>
...
@endsection
  266 changes: 17 additions & 249 deletions266  
