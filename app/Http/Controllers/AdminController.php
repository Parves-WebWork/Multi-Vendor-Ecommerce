...
use App\Notifications\VendorApproveNotifcation;
...
class AdminController extends Controller
{
    ...
    public function ActiveVendorApprove(Request $request){
        ...
        Notification::send($vuser, new VendorApproveNotifcation($request));
    ...
    public function AdminUserStore(Request $request){
        ...
        if ($request->roles) {
            $role = Role::where('name', $request->roles)->first(); // Find role by name
