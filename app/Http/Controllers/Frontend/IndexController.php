...
class IndexController extends Controller
{
    ...
    public function Index()
    {
        ...
        $skip_product_8 = Product::where('status',1)->where('category_id',$skip_category_2->id)->orderBy('id','DESC')->limit(5)->get();
    ...
    public function VendorDetails($id){
        ...
        return view('frontend.vendor.vendor_details',compact('vendors','vproducts'));

    }//end method

    public function VendorAll(){

        $vendorsname= User::where('status','active')->where('role','vendor')->orderBy('id','DESC')->get();

        return view('frontend.vendor.vendor_all',compact('vendorsname'));
