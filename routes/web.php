...
Route::get('admin/dashboard',[AdminController::class,'AdminDashobard'])->name('admin.dashobard');
...
Route::middleware(['auth', 'role:vendor'])->group(function () {
    ...
    Route::get('vendor/dashboard',[VendorController::class,'VendorDashobard'])->name('vendor.dashobard');
...
Route::controller(VendorProductController::class)->group(function(){
  //All product Route
  Route::get('vendor/all/produc','VendorAllProduct')->name('vendor.all.product');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/user/update/password', [UserController::class, 'UseruserUpdatePassword'])->name('user.update.password');
...
Route::controller(BrandController::class)->group(function(){
    ...
    Route::post('/store/brand','StoreBrand')->name('store.brand');
     ...
     //Edite Brand Route
     Route::get('/edite/brand/{id}','EditBrand')->name('edit.brand');
...
Route::controller(CategoryController::class)->group(function(){
    ...
    Route::post('/store/category','StoreCategory')->name('store.category');
     ...
     //Edite category Route
     Route::get('/edite/category/{id}','EditCategory')->name('edit.category');
...
Route::controller(SubCategoryController::class)->group(function(){
  ...
  Route::post('/store/subcategory','StoreSubCategory')->name('store.subcategory');
   ...
   //Edite category Route
   Route::get('/edite/subcategory/{id}','EditSubCategory')->name('edit.subcategory');
...
Route::controller(AdminController::class)->group(function(){
  //inactive vendor Route
  Route::get('/inactive/vendor','InactiveVendor')->name('inactive.vendor');

    //active vednor Route
    Route::get('/active/vendor','ActiveVendor')->name('active.vendor');

  //inactive vendor details Route
  Route::get('/inactive/vendor/details/{id}' , 'InactiveVendorDetails')->name('inactive.vendor.details');

   //active approve  Route
    Route::post('/active/vendor/approve' , 'ActiveVendorApprove')->name('active.vendor.approve');



  //   //Active Vendor Details Route
      Route::get('/active/vendor/details/{id}' , 'ActiveVendorDetails')->name('active.vendor.details');

  //inactive vendor approve Route
...
Route::controller(ProductController::class)->group(function(){
  //All product Route
  Route::get('/all/produc','AllProduct')->name('all.product');

    //Add product Route
    Route::get('/add/product','AddsProduct')->name('add.product');
